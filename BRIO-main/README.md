...
Brio.chat is SaaS platform that leverages the Retrieval-Augmented Generation (RAG) framework, allowing users to create multi-source chatbots. These chatbots are capable of retrieving facts from diverse sources, including PDFs, Word documents, websites and more, enhancing LLM performance and reliability. Additionally, Brio.chat makes it easy to integrate these chatbots into your own websites with simple script tags.

![Brio](./public/brio-logo-original.png)
## Features
