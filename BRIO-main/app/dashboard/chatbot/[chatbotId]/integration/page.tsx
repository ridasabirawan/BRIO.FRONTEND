...
export default async function IntegrationPage(props: {
  ...
  // Normalise the base URL to ALWAYS end with a single trailing slash. embed.js
  // builds URLs as `${brioUrl}embed.js` and `${brioUrl}widget?...`, so without
  // the slash the snippet would produce broken URLs like ".../3000embed.js".
