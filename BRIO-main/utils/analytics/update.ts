...
export async function incrementTokenCount(
  ...
  // Bucket by UTC day. The values are read back with toISOString() (UTC), so we
  // must store UTC midnight here — local midnight shifted the date back a day
  // (e.g. afternoon PKT activity showed as the previous day).
