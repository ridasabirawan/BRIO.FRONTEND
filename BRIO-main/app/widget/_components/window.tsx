...
const Message = ({
  ...
  <div
    className={`flex items-start gap-3 ${message.role === "user" ? "flex-row-reverse ml-12" : "flex-row mr-12"
      }`}
  >
    {message.role === "user" ? (
      <div
    ...
    <div
      className={`p-3 rounded-lg max-w-[80%] ${message.role === "user" ? "" : "bg-gray-200 text-gray-800"
        }`}
      style={
        message.role === "user"
