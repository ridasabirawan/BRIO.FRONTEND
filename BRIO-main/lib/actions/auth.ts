...
export async function register({
  ...
  try {
    ...
    // Reject if an account with this email already exists (regardless of password)
    ...
    return {
      success: false,
      message: "Could not create your account. Please check your details and try again.",
    };
  }
}
